...
*/
$config['tables']['users']           = 'ion_auth_users';
$config['tables']['groups']          = 'ion_auth_groups';
$config['tables']['users_groups']    = 'ion_auth_users_groups';
$config['tables']['login_attempts']  = 'ion_auth_login_attempts';
