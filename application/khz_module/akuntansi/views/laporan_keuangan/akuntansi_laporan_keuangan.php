        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>akuntansi/laporan_keuangan/neraca">
                        ...
                        <div class="col">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>akuntansi/laporan_keuangan/trial_balance">
                        ...
                        <div class="col">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>akuntansi/laporan_keuangan/labarugi">
                    ...
                    <div class="row">
                        <div class="col">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>akuntansi/excel_laporan_keuangan/neraca">
                        ...
                        <div class="col">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>akuntansi/excel_laporan_keuangan/labarugi">
