...
function current_voucher() { //voucher
        ...
        if(id){
            ...
            uniqid=id
            console.log('<?php echo base_url('akuntansi/tampilcurrentvoucher/'); ?>'+id);
            $("#modal-current-voucher").load('<?php echo base_url('akuntansi/tampilcurrentvoucher/'); ?>'+id_voucher_terpilih)
